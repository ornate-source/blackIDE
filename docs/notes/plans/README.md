...
|:-:|---|---|---|---|
| 1 | [phase-1-browser-security.md](phase-1-browser-security.md) | Browser automation strategy + enforce/hide the Browser settings tab (the `browserAllowedDomains` false-security control) | B1, B2, B8 | **Required** — a control that claims to restrict navigation but doesn't is the highest-risk item |
