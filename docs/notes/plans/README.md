...
| 3 ✅ | [phase-3-noop-toggles.md](phase-3-noop-toggles.md) | Honor the remaining no-op toggle (Reasoning display) | B6 | **Done (2026-07-22)** — reasoning stream gated; harness 381/381 |
| 4 ✅ | [phase-4-hygiene-docs.md](phase-4-hygiene-docs.md) | Untrack `tmp/` fixtures; fix README doc-accuracy items | B7, doc drift | **Done (2026-07-22)** — tmp untracked; README fixed; picker filtered; harness 386/386 |
