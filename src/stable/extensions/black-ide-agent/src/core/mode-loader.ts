...
export class ModeLoader {
    ...
    async loadAll(rootPath: string, globalConfigPath?: string): Promise<CustomMode[]> {
        ...
        const builtins: CustomMode[] = [
            ...
            { name: 'Plan', description: 'Plan & explore (no edits)', systemPrompt: '', tools: ['read_file', 'list_directory', 'grep_search', 'codebase_search', 'web_search', 'create_artifact', 'update_plan', 'complete_task', ...CODE_INTEL_READ_TOOLS, ...NOTEBOOK_READ_TOOLS], icon: 'map', source: 'builtin' },
...
5. Write idempotent endpoints where possible`,
            },
            {
                ...
                source: 'builtin',
                maxIterations: 30,
                tools: ['read_file', 'write_file', 'edit_file', 'run_command', 'grep_search', 'list_directory', 'codebase_search', 'web_search', 'create_artifact', 'update_plan', 'complete_task', ...CODE_INTEL_READ_TOOLS, ...NOTEBOOK_READ_TOOLS, ...NOTEBOOK_EDIT_TOOLS, 'rename_symbol', 'run_tests'],
...
5. Document required environment variables in README or .env.example`,
            },
            {
                ...
                tools: ['read_file', 'list_directory', 'grep_search', 'codebase_search', 'web_search',
                        'create_artifact', 'complete_task', ...CODE_INTEL_READ_TOOLS, ...NOTEBOOK_READ_TOOLS],
...
a concern to justify the review.`,
            },
            {
                ...
                source: 'builtin',
                maxIterations: 15,
                tools: ['read_file', 'list_directory', 'grep_search', 'codebase_search', 'web_search', 'create_artifact', 'update_plan', 'spawn_subagent', 'complete_task', ...CODE_INTEL_READ_TOOLS, ...NOTEBOOK_READ_TOOLS],
...
5. Generate a final walkthrough summarizing all changes`,
            },
            {
                ...
                source: 'builtin',
                maxIterations: 20,
                tools: ['read_file', 'list_directory', 'grep_search', 'codebase_search', 'web_search', 'create_artifact', 'update_plan', 'complete_task', ...CODE_INTEL_READ_TOOLS, ...NOTEBOOK_READ_TOOLS],
...
5. Document design decisions and their trade-offs`,
            },
            {
                ...
                tools: ['read_file', 'list_directory', 'grep_search', 'codebase_search',
                        'web_search', 'create_artifact', 'complete_task', ...CODE_INTEL_READ_TOOLS, ...NOTEBOOK_READ_TOOLS],
...
Do NOT write any source code.`,
            },
            {
                ...
                tools: ['read_file', 'list_directory', 'write_file', 'create_artifact',
                        'complete_task', ...CODE_INTEL_READ_TOOLS, ...NOTEBOOK_READ_TOOLS, 'rename_symbol'],
...
Write the file using write_file, then call complete_task.`,
            },
            {
                ...
                internal: true,
                maxIterations: 40,
                tools: ['read_file', 'write_file', 'edit_file', 'run_command', 'grep_search', 'list_directory', 'update_mindmap', 'complete_task', ...CODE_INTEL_READ_TOOLS, ...NOTEBOOK_READ_TOOLS, ...NOTEBOOK_EDIT_TOOLS, 'rename_symbol', 'run_tests'],
...
Use semantic HTML, ARIA attributes, and responsive design.`,
            },
            {
                ...
                tools: ['read_file', 'write_file', 'edit_file', 'run_command', 'grep_search', 'list_directory', 'update_mindmap', 'complete_task',
                        'browser_open', 'browser_screenshot', 'browser_click', 'browser_type', 'browser_read', 'browser_close', ...CODE_INTEL_READ_TOOLS, ...NOTEBOOK_READ_TOOLS, ...NOTEBOOK_EDIT_TOOLS, 'rename_symbol', 'run_tests'],
