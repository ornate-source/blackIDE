...
// Contribute settings gear icon to TitleBar and TitleBarAdjacentCenter
MenuRegistry.appendMenuItem(MenuId.TitleBar, {
	command: {
		id: 'black-ide.openSettings',
		title: localize('openBlackIdeSettings', "Black IDE Settings"),
...
MenuRegistry.appendMenuItem(MenuId.TitleBarAdjacentCenter, {
	command: {
		id: 'black-ide.openSettings',
		title: localize('openBlackIdeSettings', "Black IDE Settings"),
		icon: Codicon.settingsGear,
